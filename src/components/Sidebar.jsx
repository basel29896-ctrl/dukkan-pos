...
function NotificationsBell() {
  ...
  return (
    <Popover placement="left-end" offset={12}>
      <PopoverTrigger>
...
export default function Sidebar({ user, view, setView, navViews, onLogout, canSeeStock }) {
  return (
    <aside dir={ARABIC ? 'rtl' : 'ltr'}
      className="sticky top-0 flex h-screen w-56 shrink-0 flex-col gap-3 overflow-y-auto border-s border-divider bg-content1 p-3">
